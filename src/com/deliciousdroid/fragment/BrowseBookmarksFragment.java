...
public class BrowseBookmarksFragment extends ListFragment 
	...
	public void onActivityCreated(Bundle savedInstanceState){
		...
		mAdapter = new SimpleCursorAdapter(base, R.layout.bookmark_view, null, 
				...
				new int[]{R.id.bookmark_description, R.id.bookmark_tags, R.id.bookmark_private, R.id.bookmark_unsynced}, 0);
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		if(query != null) {    		
			return BookmarkManager.SearchBookmarks(query, tagname, username, base);
		} else {
			return BookmarkManager.GetBookmarks(username, tagname, sortfield, base);
		}
	}
